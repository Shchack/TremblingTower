...
namespace PluginMaster
{
    ...
    public static partial class PWBIO
    {
        ...
        public static void ResetPinValues()
        {
            ...
            var bounds = BoundsUtils.GetBoundsRecursive(prefab.transform, Quaternion.Euler(strokeItem.additionalAngle));
        ...
        private static void PinPreview(Camera camera)
        {
            ...
            itemRotation *= Quaternion.Inverse(Quaternion.Euler(strokeItem.additionalAngle));
            DrawPinHandles(Matrix4x4.TRS(itemPosition, itemRotation, scaleMult) * translateMatrix,
